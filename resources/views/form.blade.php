        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-container">
                    <h2>¿Necesitas ayuda? ¡Solicita tu <span class="turquoise">Spiter</span> YA!</h2>
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li class="media">
                            <i class="fas fa-check"></i>
                            <div class="media-body"><strong class="blue">Tu spiter estará ahí para ayudarte</strong></div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="form-container">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button">QUIERO MI SPITER</button>
                        </div>
